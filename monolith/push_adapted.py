...
KITS={
 ...
 "modelwars":("THE MODEL OF THE WEEK","FOUNDER","the model-proof stack map","modelwars",
  "Every Tuesday a new model gets crowned. Every Friday there is another one.\n\nThe switchers moved stacks four times this year. Their pipeline never noticed: the top models are within points of each other.\n\nThe moat is the layer above: memory, skills, the gate. None of them expire on launch day. The router just adopts the new engine under the hood.\n\nOwn the layer. Let the models fight.",
  "Stop rebuilding your stack every launch week.\n\nModels converged: the gap is the system around them. Inside Ultron the router picks the tier per job, your memory and skills survive every release, and a new model just means your desk got faster overnight.\n\nZero migration. Same commands. Better engine.\n\nModel FOMO is a part-time job that never touches revenue.",
  "Four stack migrations this year, zero pipeline difference. The layer above the models is the only safe seat.\n\nDrop FOUNDER below and I will DM you the model-proof stack map.\n\nSave this before the next launch thread."),
 "dayone":("DAY ONE: THE FIVE PLAYS","BUILDER","the day-one playbook","dayone",
  "Day one with Claude decides month three.\n\nThe five plays: teach it your business with one interview, make it read twenty accounts before it speaks, feed it your five best posts, put one chore on a trigger, end with the 07:00 digest.\n\nSixty minutes total. Skipping play one breaks the other four: generic context makes generic outputs.\n\nDay one is the floor. It only compounds.",
  "The first hour on the desk, played right:\n\n/init interviews you once and every answer after gets sharper. The first research run scores twenty accounts against YOUR customer. Your voice locks from five pasted posts. One chore goes on a trigger with sends parked. The digest closes the day.\n\nOne hour, five plays, and corrections start becoming rules the same night.",
  "Five plays, sixty minutes, and the desk already ran its first real job with every send parked for your tap.\n\nDrop BUILDER below and I will DM you the day-one playbook, play by play.\n\nSave this for your first hour."),
 "neverhire":("THE HIRING FREEZE","FOUNDER","the freeze list + role tests","neverhire",
  "I froze five job openings this year.\n\nLead gen runs overnight on my ICP. Support triage drafts first replies in seconds. Content ops never misses Monday. Follow-ups chase every quiet thread, parked for my tap. Reviews get asked at the right moment, every time.\n\nThe test before any posting: would a checklist do this job? Then it is a flow, not a hire.\n\nFreeze the repetitive. Hire the judgement.",
  "Most businesses do not need more employees. They need systems that work around the clock.\n\nThe five roles my desk absorbed: lead generation, support triage, content ops, sales follow-ups, review collection. Every external touch still parks for one tap.\n\nPeople for taste, relationships and closing calls. Flows for everything that repeats.\n\nRun the checklist test before your next job posting.",
  "Five roles frozen, five salaries kept in the company, zero missed Mondays.\n\nDrop FOUNDER below and I will DM you the freeze list with the checklist test per role.\n\nSave this before you write the next job ad."),
 "boring":("BORING BEATS CLEVER","OPERATOR","the 4-second test + boring rulebook","boring",
  "Clever got 800 views. Boring got 47,000. Same person, same niche, same week.\n\nYou get 1.7 seconds in the scroll. One idea per post, words a 12-year-old gets, payoff visible in two seconds. Confusion kills reach.\n\nMy desk runs the 4-second test on every draft before I see it: fail one box, rewrite.\n\nClever is for your ego. Boring is for their scroll.",
  "Your audience is not reading. They are scrolling, at 1.7 seconds per post.\n\nThe brain trusts predictable: one idea, plain words, familiar format, instant payoff. The clever version of the same idea did 800 views; the boring one did 47,000.\n\nPULSE drafts to those rules and ranks every draft against the 4-second test before review. One trader client went 2K to 30K followers in 25 days on the switch.\n\nThe smartest content looks the simplest.",
  "800 versus 47,000 on the same idea: the delivery was the only variable.\n\nDrop OPERATOR below and I will DM you the 4-second test plus the boring rulebook my desk enforces.\n\nSave this and run it on your next post."),
 "loweffort":("LOW EFFORT, DONE RIGHT","OPERATOR","the front-loaded content system","loweffort",
  "The gurus sell effortless posting. The feed ignores it: recycled content gets recycled reach.\n\nLow effort is an output, not an input. Build once, heavy: your voice sampled, your hook bank stocked, your cadence wired. Then daily really is one line and one tap.\n\nFourteen posts a week from one planning line, each passing the boring test before I see it.\n\nWork hard once. Post easy forever.",
  "Yes, low effort content works. Not the guru way.\n\nZero effort in reads as zero value out: audiences smell templates. The honest version moves the effort upstream: one heavy weekend building voice, hook bank and cadence into the desk, then ten real minutes a day.\n\nSame daily minutes as the gurus promise. Opposite outcome, because the system compounds.\n\nFront-load, then fly.",
  "Ten minutes a day is real, but only after the one honest weekend of building the system behind it.\n\nDrop OPERATOR below and I will DM you the front-loaded content system, piece by piece.\n\nSave the honest version of low effort."),
 "wrongaisle":("THE WRONG PLUGIN AISLE","BUILDER","the founder plugin checklist","wrongaisle",
  "The plugin lists are written for engineers: repo graphs, code navigators, god-node detectors. Impressive, and irrelevant to your quarter.\n\nFounder plugins are desks: research, outbound, deals, content, paperwork. Each install owns an outcome you can name.\n\nThe test: a receipt in 48 hours. Twenty briefs, ten drafts, one proposal out, or uninstall.\n\nShop by outcome, never by demo.",
  "If the plugin page shows code, you are in the wrong aisle. If it shows pipeline, install.\n\nInside Ultron every install is a desk with a named outcome: CORTEX lands briefs, SPECTER lands replies, STRIKER lands closes. Five desks cover a founder company; the sixth seat is you, on the gate.\n\nDemand a receipt in 48 hours from anything you add.\n\nBuy desks. Skip toys.",
  "Ten developer plugins deep and the follow-ups were still hand-written. Wrong aisle, whole time.\n\nDrop BUILDER below and I will DM you the founder plugin checklist with the 48-hour receipt test.\n\nSave this before your next install spree."),
 "selflearn":("AGENTS THAT LEARN","BUILDER","the learning-loop setup","selflearn",
  "Most agents finish a task and forget everything. Same mistakes, every run, forever.\n\nThe fix is the learning loop: evaluate, reflect, store, apply. Corrections become rules, rules become skills, and run one hundred behaves nothing like run one.\n\nMy no-list has 34 rules. I wrote none of them twice.\n\nIf it cannot remember you, why are you training it daily?",
  "An agent without memory is a groundhog day you pay for in attention.\n\nInside Ultron the loop grades its own output, files the lesson, and applies it on the next run. Say no discounts once and it is blocked forever. Fix a draft once and the fix generalizes.\n\nIt learns alone and still sends only with your tap.\n\nDemand memory before you demand intelligence.",
  "34 rules in my no-list, each written exactly once. The desk did the remembering.\n\nDrop BUILDER below and I will DM you the learning-loop setup.\n\nSave this and test what yours remembers tomorrow."),
 "carouselcode":("THE CAROUSEL CODE","OPERATOR","the 5-pattern review checklist","carouselcode",
  "Eight months of carousels taught me it was never the pretty template.\n\nThe patterns: the cover sells only the swipe. One beat per page. Slide two opens a loop the last page closes. One page is built to be saved. One CTA, not five.\n\nMy desk drafts to the code by default now, five boxes checked before I see anything.\n\nGrowth stopped being luck and became a consequence.",
  "High-performing carousels follow specific patterns, and none of them are aesthetic.\n\nCover as doorman, one beat per page, an open loop from slide two, a save page built in, a single CTA. Thirty seconds of review against five boxes.\n\nPULSE builds every deck to the code before it reaches me.\n\nSame niche, same effort, patterned delivery: the metrics followed.",
  "Five patterns, thirty seconds of review per post, eight months of proof behind them.\n\nDrop OPERATOR below and I will DM you the 5-pattern review checklist.\n\nSave the code and grade your last carousel against it."),
 "onetool":("FIVE ASSISTANTS, NO MEMORY","FOUNDER","the one-desk migration map","onetool",
  "The listicles sell a specialist for every slice of your day: inbox tool, calendar tool, meeting tool, note tool.\n\nNone of them know the others exist. Five memories means no memory, and the integration is you, at 23:00.\n\nOne desk holds all of it with one memory underneath: triage at night, drafts in your voice by 06:00, digest at 07:00.\n\nNever add a tool that cannot share memory.",
  "You do not need five assistants. You need one that remembers.\n\nThe inbox tool cannot see the deal. The meeting tool never met your pipeline. You re-explain your business to software all day.\n\nUltron holds inbox, calendar and pipeline over one memory: the follow-up references the call, the call references the deal. Five subscriptions became one meter in cents.\n\nMemory or nothing: that filter kills most of the listicle.",
  "Five logins, five silos, zero shared context: the real cost of the assistant listicle.\n\nDrop FOUNDER below and I will DM you the one-desk migration map.\n\nSave this before you add tool number six."),
 "oneskill":("ONE SKILL, FIVE INCOMES","FOUNDER","the five-shapes framework","oneskill",
  "You do not need a new skill. You need five shapes of the one you own.\n\nThe service: done for them, first cash. The product: packaged once. The content: proof in public that sells the first two. The teaching: your method, priced. The tool: your judgement, minted as a skill others run.\n\nOne desk runs all five with the same memory and voice.\n\nService first. Tool last. Sequence beats ambition.",
  "Everyone hunts a new skill. The money is in reshaping the one you have.\n\nFive shapes: service, product, content, teaching, tool. The desk briefs and chases the service, assembles the product, turns client work into daily posts, structures the method, and mints the workflow as a runnable skill.\n\nFive incomes, one login, zero context lost between them.\n\nEach shape funds the next.",
  "One skill, five income shapes, one desk running the whole sequence.\n\nDrop FOUNDER below and I will DM you the five-shapes framework with the order that works.\n\nSave this and pick your second shape."),
 "firstpass":("FIRST PASS, HUMAN FINISH","OPERATOR","the org chart install map","firstpass",
  "Most people run Claude like a chat box: one prompt, one person typing, nine roles unfilled.\n\nWired as an org chart, ten skills work like a team: researcher, editor, analyst, deck builder. Nine first passes wait at 07:00 and your day starts at the decision layer.\n\nIt drafts, you decide. Nothing external ships without a human finish.\n\nSame headcount, triple the throughput.",
  "This is not about replacing people. It is what work looks like when the desk does the first pass and humans do the thinking.\n\nTen installed skills run like an org chart inside Ultron. The volume work reads, sorts and drafts itself; your team edits taste instead of typos. One roster skill even mints new skills from repeated jobs.\n\nThe last touch stays human, always.\n\nEveryone moves up one level.",
  "Nine first passes done before 07:00, one human finish on everything that ships.\n\nDrop OPERATOR below and I will DM you the org chart install map, role by role.\n\nSave this and audit where your first pass goes."),
 "studyyou":("IT STUDIED MY BEST POSTS","OPERATOR","the self-study loop setup","studyyou",
  "Your best posts are training data you own, sitting unused in your profile.\n\nThe desk pulled my 50 winners with their numbers, ran the autopsy, and the data disagreed with my taste: short openers, one number per post, questions that end.\n\nThe findings became an installed skill, not a note. The 51st post came out sounding like my best day.\n\nStudy first. Generate second.",
  "What if Claude learned from your own best posts before writing a single new one?\n\nThat is the self-study loop: extract the winners, analyze what actually worked, distill the patterns into a reusable skill, and generate from evidence only you own.\n\nThe study reruns monthly as new winners land. Generic AI writes averages; this writes you.\n\nYour archive is the moat.",
  "50 posts studied, one skill distilled, and the next draft ranked against my own winners before I saw it.\n\nDrop OPERATOR below and I will DM you the self-study loop setup.\n\nSave this and go count your unused winners."),
 "proofstack":("BUILDS THAT PAY RENT","BUILDER","the three builds, step by step","proofstack",
  "Demo projects impress recruiters. They do not deposit.\n\nThe three builds that invoice: a lead machine that sources and briefs nightly, a follow-up loop with zero dropped threads, a content desk shipping fourteen posts a week. Each is an evening, not a semester.\n\nContent warms leads, leads feed loops, loops close.\n\nThe filter: would a client pay for it? Invoice or hobby.",
  "Stop building portfolio pieces. Build things that invoice.\n\nThree builds on the Ultron desk: the lead machine (ICP sourced nightly, openers parked for your tap), the follow-up loop (fires on silence, logs every reply), the content desk (14 posts from one line, gated).\n\nOne memory and one gate underneath, each build feeding the next.\n\nEvery build reports in money terms, not stars.",
  "Three evenings, three builds, all reporting in money terms: briefs to calls, threads to invoices, posts to inbound.\n\nDrop BUILDER below and I will DM you the three builds, step by step.\n\nSave this and ship the first one this week."),
 "tokendiet":("THE CENTS DISCIPLINE","BUILDER","the 5-habit cents checklist","tokendiet",
  "Your AI bill is a habit, not a price. Same tool, same work: one founder pays cents, another pays multiples.\n\nThe five habits: clear context between tasks, right tier per job, filter noise before it reads, keep memory files lean, bundle small asks into one pass.\n\nOn the desk the discipline is default: the router tiers every turn and caps sit on every flow.\n\nDo not chase cheap. Chase clean: it pays twice.",
  "Spending too much on AI without changing how you work is a habits problem.\n\nFresh context per task, the right tier per job, signal instead of bulk, lean memory files, batched runs. Every one of those cuts cost AND raises quality.\n\nUltron automates the discipline: router-picked tiers, per-task resets, spend caps by default.\n\nCents by design, not by effort.",
  "Five habits separate the founders who pay cents from the ones who pay multiples for the same output.\n\nDrop BUILDER below and I will DM you the 5-habit cents checklist.\n\nSave this before your next session."),
 "brandguard":("ON-BRAND WITHOUT A DESIGNER","OPERATOR","the brand guardrail setup","brandguard",
  "Ten posts, ten shades of you: without a designer every asset negotiates its own fonts and colors, and drift reads as amateur.\n\nThe fix is configuration: your look written once as token law, 822 components already obeying it, every deck and page born in the same family.\n\nApprove the pattern once; every instance inherits the blessing.\n\nScreenshot any two assets. Same company? Then it works.",
  "Every asset on-brand, no designer on payroll.\n\nColors, type and logo rules live in one token file inside Ultron. Crescendo assembles decks, pages and posts from a component pack that is on-brand by birth. The proposal matches the landing page matches the carousel.\n\nOn-brand became the fast path: no review cycles, no drift fixes.\n\nThe design retainer became a token file.",
  "One token file, 822 obedient components, zero drift across everything that ships.\n\nDrop OPERATOR below and I will DM you the brand guardrail setup.\n\nSave this and run the two-screenshot test on your last five assets."),
}
