# master claude in 2 minutes - caption kit
...
The fix takes two minutes and lives in four inputs most people skip.
...
Most people type one line into Claude and wonder why the answer is generic. The whole fix is four inputs, task, context, standard, outcome, plus the mode you open with.

Comment CLAUDE and I will send you the exact 4-input prompt formula I run every day.
