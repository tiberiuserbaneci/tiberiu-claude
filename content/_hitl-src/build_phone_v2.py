...
T2.CONTENT=[
  ...
  ("COMPUTER", [[wo("It runs")],[co("its own computer.")]], f"{PH}/p2_build.png", 1.0),
  ("UNITS", [[wo("A team of seven,")],[co("on tap.")]], f"{PH}/p2_units.png", 1.0),
...
if __name__=="__main__":
    a=T2.deck_poll(f"{T2.OUTBASE}/phv2_tt",False); b=T2.deck_poll(f"{T2.OUTBASE}/phv2_ig",True)
