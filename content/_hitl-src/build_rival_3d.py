...
T2.CONTENT=[
 ("RESEARCH", [[wo("They pay for Apollo.")],[co("I just ask.")]],   "Same lead data, pulled live in the chat. No seat, no export.", [mu("Apollo, $49/mo."),co("  Now cents.")], f"{R}/research.png", 0.95),
 ...
 ("CRM",      [[wo("They run Salesforce.")],[co("I just ask.")]],   "Deals move by asking, not by logging into a CRM all day.", [mu("Salesforce, $25/mo."),co("  Now cents.")], f"{R}/crm.png", 0.95),
 ...
 ("THE STACK",[[wo("Twelve tools.")],[co("One chat.")]],            "Every job above runs through a single subscription.", [mu("A $187/mo stack."),co("  Now cents.")], f"{R}/stack.png", 0.90),
 ...
 ("THE BILL", [[wo("They pay for all this.")],[co("I pay for a chat.")]], "Their stack is a monthly bill. Mine does the same work for cents.", [mu("$186.99 every month."),co("  Now cents.")], f"{R}/cost.png", 0.93),
]
