...
CONTENT=[
 ("THE ASK",[[wo("Name a category")],[co("and a city.")]],"ask"),
 ("THE PULL",[[wo("It walks the map")],[co("for you.")]],"results"),
 ("WHAT YOU GET",[[wo("Phone, site, rating,")],[co("hours. Per place.")]],"fields"),
 ("FAST OR FULL",[[wo("Names fast,")],[co("or the full file.")]],"modes"),
 ("AT SCALE",[[wo("Five hundred")],[co("per search.")]],"scale"),
 ("TO OUTBOUND",[[wo("Straight into")],[co("your outbound.")]],"pipeline"),
 ("THE FULL FILE",[[wo("Everything you need")],[co("to reach them.")]],"coverage"),
 ("CLEAN DATA",[[wo("No half-empty")],[co("rows.")]],"accuracy"),
]
CTA_SLIDE=("GET THE SETUP",[[wo("Local leads,")],[co("on tap.")]],"cta")
...
tt=build_variant(6, f"{TE}/roll3/maps_3d_tt", overlay=False)   # TikTok: cover + 6 content + CTA = 8
ig=build_variant(8, f"{TE}/roll3/maps_3d_ig", overlay=True)    # IG: overlay cover + 8 content + CTA = 10
print("TikTok 3D slides:",tt," IG slides:",ig)
# montages
for od,name in [("maps_3d_tt","maps3d_tt"),("maps_3d_ig","maps3d_ig")]:
