...
def loop():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 38px;display:flex;align-items:center;gap:36px">
...
def define():
    return f'''<div style="width:900px;{CARD};padding:34px 40px 42px">
      ...
      <div style="background:linear-gradient(160deg,rgba(200,70,35,.14),rgba(200,70,35,.04));border:1px solid rgba(200,70,35,.32);border-radius:14px;padding:18px 22px;display:flex;align-items:center;gap:16px;box-shadow:0 0 40px rgba(200,70,35,.12)">
        ...
        <div style="font-family:'DM Mono';font-size:13px;color:rgb({ACC})">compiled · recurring · yours</div></div></div></div>'''
...
def trigger():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 42px">
      ...
      <div style="font-family:'DM Mono';font-size:15px;color:{MUT};text-align:center;margin-top:6px">same time, every day, laptop open or shut</div></div>'''
...
def trap():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 40px">
      ...
      <div style="display:flex;justify-content:space-between;font-family:DM Mono;font-size:13px;color:{DIM};margin-top:8px"><span>$0</span><span style="color:rgb({ACC})">drained</span></div></div>'''
...
def gate():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 42px">
      ...
      <div style="font-family:'DM Mono';font-size:14px;color:{MUT};text-align:center;margin-top:18px">it sprints internally, then waits at the door before anything leaves</div></div>'''
