...
CONTENT=[
 ...
 ("IN PARALLEL",[[wo("Ten at once.")],[co("One operator.")]],"parallel"),
...
tt=build_variant(6, f"{TE}/roll3/jobs_3d_tt", overlay=False)   # TikTok: cover + 6 content + CTA = 8
ig=build_variant(8, f"{TE}/roll3/jobs_3d_ig", overlay=True)    # IG: overlay cover + 8 content + CTA = 10
print("TikTok 3D slides:",tt," IG slides:",ig)
# montages
for od,name in [("jobs_3d_tt","jobs3d_tt"),("jobs_3d_ig","jobs3d_ig")]:
