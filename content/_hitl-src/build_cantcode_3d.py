...
T2.CLOSE=dict(l1="Save this for",l2="the day you build.",q="What would you ship without code?")
if __name__=="__main__":
    a=T2.deck_close(f"{T2.OUTBASE}/code_tt",False); b=T2.deck_close(f"{T2.OUTBASE}/code_ig",True)
