...
J={
 "charge":"a payment card titled 'New charge' with three labelled lines 'Customer: Acme Co', 'Amount: $4,000', 'Card: on file', and an orange 'Charge' button at the bottom.",
 "invoice":"an invoice card titled 'Invoice 1042' with labelled lines 'To: Acme Co', 'Amount: $4,000', 'Due: Net 15', and an orange 'Send invoice' button.",
 "paylink":"a payment-link card titled 'Payment link' with a line 'Pro plan, $290 per month', a short URL line 'pay.51ultron.com', and an orange 'Copy link' button.",
 "subs":"a subscription card titled 'New subscription' with lines 'Plan: Pro', 'Price: $290 per month', 'Status: active', and a small orange ON toggle switch on the right.",
 "mrr":"a revenue stat panel with a very large orange number '$48k' and a label 'MRR', and to the right two small stacked rows 'ARR  $576k' and 'Outstanding  $12k'.",
 "approval":"an approval card with a header 'Approval needed', a bold line 'Charge Acme $4,000', a sub-line 'waiting for your yes', and two buttons, an orange 'Approve' and an outlined 'Hold'.",
 "customers":"a list panel titled 'Recent payments' with four rows, each a customer name and an amount: 'Acme Co   $4,000', 'Globex   $290', 'Initech   $1,200', 'Umbrella   $900'.",
 "modules":"a checklist card titled 'Tools that shipped' with six rows, each a small orange check and a label: 'Charge a card', 'Send an invoice', 'Payment link', 'Subscriptions', 'Revenue metrics', 'Human approval'.",
}
def gen(prompt,out):
    ...
    return False
OUT=f"{TE}/roll3/models_modules"; os.makedirs(OUT,exist_ok=True)
