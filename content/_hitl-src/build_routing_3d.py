...
JOBS=f"{TE}/roll3/models_routing"; CTA=f"{TE}/roll3/cta3d/cta-builder.png"
T.LOGO3D=f"{LIB}/claude-logo-3d-metal.png"   # vary the cover logo (HITL used glossy)

COVER=dict(role="cover",eyebrow="MODEL ROUTING",head=[[wo("One model loses.")],[co("Route instead.")]],
           sub="Type plain English. It sends each job to the model that actually wins it.")
# (eyebrow, head, object-key) - first 6 -> TikTok 8, all 8 -> IG 10
CONTENT=[
 ("THE PROBLEM",[[wo("One model, all jobs.")],[co("It loses most.")]],"mixed"),
 ("THE ROUTER",[[wo("Type it.")],[co("It routes.")]],"router"),
 ("THE MAP",[[wo("Each job,")],[co("its own model.")]],"map"),
 ("THE TIERS",[[wo("Lite, smart,")],[co("or deep.")]],"tiers"),
 ("AUTO-PICK",[[wo("You never pick.")],[co("It does.")]],"autopick"),
 ("THEY CHAIN",[[wo("Jobs hand off")],[co("to each other.")]],"chain"),
 ("THE COST",[[wo("Cheap on easy.")],[co("Deep on hard.")]],"cost"),
 ("ONE PLACE",[[wo("Many jobs.")],[co("One chat.")]],"onechat"),
]
CTA_SLIDE=("GET THE MAP",[[wo("The routing map,")],[co("yours.")]],"cta")
...
tt=build_variant(6, f"{TE}/roll3/routing_3d_tt", overlay=False)   # TikTok: cover + 6 content + CTA = 8
ig=build_variant(8, f"{TE}/roll3/routing_3d_ig", overlay=True)    # IG: overlay cover + 8 content + CTA = 10
print("TikTok 3D slides:",tt," IG slides:",ig)
# montages
for od,name in [("routing_3d_tt","routing3d_tt"),("routing_3d_ig","routing3d_ig")]:
