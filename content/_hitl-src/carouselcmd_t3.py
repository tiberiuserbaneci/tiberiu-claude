...
def oldbill():
    ...
    return f'''<div style="width:900px;{CARD};min-height:740px;display:flex;flex-direction:column;justify-content:space-between;padding:34px 40px 40px">
      ...
      <div style="font-family:DM Mono;font-size:14px;color:{MUT};margin-top:18px">seven days and three back-and-forths for one carousel</div></div>'''
...
def command():
    ...
    return f'''<div style="width:900px;{CARD};min-height:740px;display:flex;flex-direction:column;justify-content:space-between;padding:34px 40px 38px">
      ...
      <div style="display:flex;align-items:center;gap:12px;margin-top:8px;background:#191614;border:1px solid rgba(200,70,35,.24);border-radius:12px;padding:14px 18px">
        ...
        <span style="font-family:DM Mono;font-size:14px;color:#e9e3d7">building 10 slides · your voice · your tokens...</span></div></div>'''
...
def visuals():
    ...
    return f'''<div style="width:900px;{CARD};min-height:740px;display:flex;flex-direction:column;justify-content:space-between;padding:34px 40px 40px">
      ...
      <div style="display:flex;gap:30px;align-items:flex-end;border-top:1px solid rgba(255,255,255,.08);padding-top:20px">
        ...
        <div><div style="font-family:'DM Mono';font-weight:500;font-size:30px;color:#e9e3d7">DM Mono</div><div style="font-family:DM Mono;font-size:12px;color:{MUT}">labels · meta</div></div></div></div>'''
...
def slides():
    ...
    return f'''<div style="width:900px;{CARD};min-height:740px;display:flex;flex-direction:column;justify-content:space-between;padding:34px 40px 40px">
      ...
      <div style="font-family:DM Mono;font-size:14px;color:{MUT};margin-top:14px">cover · hook · proof · steps · CTA: the structure that already works</div></div>'''
...
def math_():
    return f'''<div style="width:900px;{CARD};min-height:740px;display:flex;flex-direction:column;justify-content:space-between;padding:34px 40px 42px">
      ...
      <div style="font-family:DM Mono;font-size:14px;color:{MUT};margin-top:20px">the desk runs on cents; the retainer stays in the bank</div></div>'''
