#!/usr/bin/env python3
# FROM ZERO TO COMPANY - full-bleed build-arc (TikTok second account). Same theme, structurally DIFFERENT from v1:
...
SECT=[
 ("COMMAND",  [[wo("It starts with one command.")]], "mob_home", 0),
 ("BUILD",    [[wo("It builds the product.")]],       "h_computer", 150),
 ("WORKSPACE",[[wo("It opens the workspace.")]],      "h_projects", 150),
 ("UNITS",    [[wo("It staffs every unit.")]],        "h_skills", 150),
 ("OUTBOUND", [[wo("It runs the outbound.")]],        "mob_jobs", 0),
 ("PLAYBOOKS",[[wo("It ships the playbooks.")]],      "h_playbooks", 150),
 ("STACK",    [[wo("It connects your tools.")]],      "h_stack", 150),
 ("ULTRON",   [[wo("From zero to a company.")],[co("One chat.")]], None, 0),
]
...
if __name__=="__main__":
    a=deck(f"{T2.OUTBASE}/zero_tt",False); b=deck(f"{T2.OUTBASE}/zero_ig",True)
