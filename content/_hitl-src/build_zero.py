...
T2.CONTENT=[
  ...
  ("UNITS", [[wo("It staffs")],[co("every unit.")]], f"{PH}/p2_units.png", 1.0),
  ("BUILD", [[wo("It builds")],[co("the product.")]], f"{PH}/p2_build.png", 1.0),
...
if __name__=="__main__":
    a=T2.deck_poll(f"{T2.OUTBASE}/zero_tt",False); b=T2.deck_poll(f"{T2.OUTBASE}/zero_ig",True)
