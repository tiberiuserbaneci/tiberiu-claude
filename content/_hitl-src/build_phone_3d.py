#!/usr/bin/env python3
# I RUN IT FROM MY PHONE - 9:16 3D, TikTok + IG. Freedom/mobility founder fantasy.
# Objects = REAL Ultron mobile app (app.51ultron.com captured live) inside a coded phone frame.
...
if __name__=="__main__":
    a=T2.deck(f"{T2.OUTBASE}/phone_tt",False)
    T2.montage(f"{T2.OUTBASE}/phone_tt","phone_tt",a); print("tt",a)
