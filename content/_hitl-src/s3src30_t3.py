...
def burners():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 34px">
      ...
      <div style="position:relative;height:456px">
        ...
        {"".join(f'<div style="position:absolute;left:{x-4}px;top:{by-38}px;width:158px;background:linear-gradient(160deg,#332f2a,#211e1a);border:1.5px solid rgba(255,255,255,.10);border-radius:16px;padding:14px 14px;box-shadow:0 20px 34px rgba(0,0,0,.5)"><div style="font-family:DM Mono;font-weight:500;font-size:13px;letter-spacing:-.01em;color:#eae4d8;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">{dom}</div><div style="display:flex;align-items:center;gap:7px;margin-top:9px"><span style="width:8px;height:8px;border-radius:50%;background:#c84623"></span><span style="font-family:DM Sans;font-size:13px;color:#a8a296">disposable</span></div></div>' for dom,x in burn)}
      </div>
