#!/usr/bin/env python3
# LOOK LIKE A FUNDED STARTUP - NORMAL Vertex GTM dashboards (no phone), TikTok+IG (deck_poll)
...
T2.CONTENT=[
  ("RESEARCH", [[wo("Briefs like")],[co("a research team.")]], f"{D}/m5_01.png", 1.0),
  ("OUTREACH", [[wo("Outreach like")],[co("a full floor.")]], f"{D}/m5_02.png", 1.0),
  ("PIPELINE", [[wo("A pipeline")],[co("that looks staffed.")]], f"{D}/m5_03.png", 1.0),
  ("PROJECTS", [[wo("Client work,")],[co("all organized.")]], f"{D}/m5_04.png", 1.0),
  ("UNITS", [[wo("Seven units,")],[co("one operator.")]], f"{D}/m5_05.png", 1.0),
  ("PROPOSALS", [[wo("Proposals that")],[co("look funded.")]], f"{D}/m5_06.png", 1.0),
  ("STACK", [[wo("The stack of")],[co("a funded team.")]], f"{D}/m5_07.png", 1.0),
...
if __name__=="__main__":
    a=T2.deck_poll(f"{T2.OUTBASE}/mat5_tt",False); b=T2.deck_poll(f"{T2.OUTBASE}/mat5_ig",True)
    T2.montage(f"{T2.OUTBASE}/mat5_tt",f"mat5_tt",a); T2.montage(f"{T2.OUTBASE}/mat5_ig",f"mat5_ig",b)
    print("tt",a,"ig",b)
