...
# Hooks rewritten to viral structures (Stop-X / "this vs not" contrast / bold-claim+stakes / number) - the
# old descriptive 2-liners did not scroll-stop. GTM -> services per operator. Covers = hook + logos below.
CFG={
 "code":dict(logo="matte", eyebrow="CLAUDE CODE", cover=[[wo("Stop writing code.")],[co("Just describe it.")]],
   sub="It plans, edits and tests inside your project, then opens the change for review.",
   content=[
    ("START",[[wo("One line")],[co("starts it.")]],"start"),
    ("MEMORY",[[wo("It learns your repo")],[co("in one command.")]],"init"),
    ("PLAN FIRST",[[wo("It plans first.")],[co("You approve.")]],"plan"),
    ("LET IT RUN",[[wo("It edits, tests,")],[co("fixes itself.")]],"run"),
    ("RESUME",[[wo("Resume any session,")],[co("full context.")]],"resume"),
    ("ONE ASK",[[wo("Describe it.")],[co("It ships the PR.")]],"proof"),
    ("WHY",[[wo("A teammate,")],[co("not autocomplete.")]],"why"),
    ("THE LOOP",[[wo("Start. Describe.")],[co("Review.")]],"loop"),
   ], cta=("GET THE SETUP",[[wo("Comment "),co("CODE")],[wo("for the setup.")]],"cta")),
 "projects":dict(logo="glossy", eyebrow="CLAUDE PROJECTS", cover=[[wo("Stop re-explaining")],[co("your business to AI.")]],
   sub="Set your rules, docs and context once. Every chat starts smart.",
   content=[
    ("THE PAIN",[[wo("You paste context")],[co("into every chat.")]],"pain"),
    ("SET ONCE",[[wo("Set it once.")],[co("It never forgets.")]],"setonce"),
    ("KNOWLEDGE",[[wo("It reads your docs,")],[co("every chat.")]],"knowledge"),
    ("MEMORY",[[wo("It remembers")],[co("what you did.")]],"activity"),
 ...
 "skills":dict(logo="metal", eyebrow="THE SKILL CATALOG", cover=[[wo("Most AI is one model.")],[co("Mine is a team of 7.")]],
 ...
 "chat":dict(logo="glossy", eyebrow="ONE CHAT BOX", cover=[[wo("12 tabs ran my work.")],[co("Now one chat does.")]],
   sub="Eight habits moved every services job into one AI chat box, with one memory underneath.",
   content=[
    ("ONE BOX",[[wo("One box,")],[co("not twelve tabs.")]],"onebox"),
    ("SLASH IT",[[wo("Slash the agent")],[co("that owns it.")]],"slash"),
    ("PICK A TIER",[[wo("Pay deep")],[co("only when it counts.")]],"tier"),
    ("MEMORY",[[wo("It loads context")],[co("before you type.")]],"memory"),
    ("UPLOAD ONCE",[[wo("Files become")],[co("context.")]],"upload"),
    ("BACKGROUND",[[wo("Long jobs run")],[co("while you go.")]],"background"),
    ("FORK IT",[[wo("Branch a thread")],[co("without losing it.")]],"fork"),
