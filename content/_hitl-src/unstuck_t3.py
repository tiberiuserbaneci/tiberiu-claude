...
def floor():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 38px"><div style="display:flex;align-items:center;gap:34px">
      ...
      {foot([("88%","STUCK HERE"),("0","PROGRESS"),("zero","EVERY START")])}</div>'''
...
def memory():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 38px">
      ...
      {foot([("4","THINGS AVOIDED"),("every","SESSION"),("0","REPEATS")])}</div>'''
...
def jobs():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 38px">
      ...
      <div style="display:inline-block;margin-top:16px;background:rgba(204,120,92,.10);border:1px solid rgba(204,120,92,.28);border-radius:999px;padding:8px 16px;font-family:DM Mono;font-size:13px;color:#e9e3d7">you: watching, coffee in hand</div>
      {foot([("40","LEADS PULLED"),("68%","DONE"),("you","WATCHING")])}</div>'''
...
def ship():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 40px">
      ...
      <div style="font-family:DM Mono;font-size:14px;color:{MUT};margin-top:8px">two lanes, same hour: your time goes to revenue, not to the build</div>
      {foot([("2","LANES"),("same","HOUR"),("revenue","YOUR TIME")])}</div>'''
...
def routines():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 40px">
      ...
      <div style="font-family:DM Mono;font-size:14px;color:{MUT};margin-top:16px">you: asleep &nbsp;·&nbsp; the work: staged by 07:00</div>
      {foot([("3","NIGHT JOBS"),("07:00","STAGED BY"),("asleep","YOU")])}</div>'''
...
def gap():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 34px">
      {lv("?","Nobody told you level 3 exists","THE GAP")}{rungs}
      {foot([("3","THE HIDDEN LEVEL"),("5","LEVELS"),("most","STUCK AT 1")])}</div>'''
...
def gate():
    return f'''<div style="width:900px;{CARD};padding:34px 40px 42px">
      ...
      {foot([("full","ASCENT"),("1","YOUR TAP"),("0","UNCLIPPED")])}</div>'''
...
def ceiling():
    return f'''<div style="width:900px;{CARD};padding:40px;text-align:center">
      ...
      <div style="display:inline-flex;align-items:center;gap:9px;margin-top:20px;background:rgba(204,120,92,.10);border:1px solid rgba(204,120,92,.3);border-radius:999px;padding:9px 18px">
        ...
        <span style="font-family:DM Mono;font-size:14px;color:#e9e3d7">all systems running</span></div>
      {foot([("5","LEVEL"),("0","CLICKS"),("running","ALL SYSTEMS")])}</div>'''
