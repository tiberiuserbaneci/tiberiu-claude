...
JOBS=f"{TE}/roll3/models_modules"; CTA=f"{TE}/roll3/cta3d/cta-founder.png"
T.LOGO3D=f"{LIB}/claude-logo-3d-matte.png"   # vary the cover logo (HITL used glossy)

COVER=dict(role="cover",eyebrow="NEW: BILLING",head=[[wo("Now it can")],[co("take money.")]],
           sub="It just learned to charge cards, send invoices and read your revenue, from the chat.")
# (eyebrow, head, object-key) - first 6 -> TikTok 8, all 8 -> IG 10
CONTENT=[
 ("CHARGE",[[wo("Charge a card")],[co("from the chat.")]],"charge"),
 ("INVOICE",[[wo("Send an invoice")],[co("in one line.")]],"invoice"),
 ("PAYMENT LINK",[[wo("A payment link,")],[co("for any deal.")]],"paylink"),
 ("SUBSCRIPTIONS",[[wo("Start a plan,")],[co("recurring.")]],"subs"),
 ("REVENUE",[[wo("Your MRR,")],[co("on demand.")]],"mrr"),
 ("THE GATE",[[wo("It asks before")],[co("it charges.")]],"approval"),
 ("THE LEDGER",[[wo("Every customer,")],[co("every payment.")]],"customers"),
 ("HOW",[[wo("New tools ship")],[co("as modules.")]],"modules"),
]
CTA_SLIDE=("GET THE SETUP",[[wo("Billing,")],[co("in your chat.")]],"cta")
...
tt=build_variant(6, f"{TE}/roll3/modules_3d_tt", overlay=False)   # TikTok: cover + 6 content + CTA = 8
ig=build_variant(8, f"{TE}/roll3/modules_3d_ig", overlay=True)    # IG: overlay cover + 8 content + CTA = 10
print("TikTok 3D slides:",tt," IG slides:",ig)
# montages
for od,name in [("modules_3d_tt","modules3d_tt"),("modules_3d_ig","modules3d_ig")]:
