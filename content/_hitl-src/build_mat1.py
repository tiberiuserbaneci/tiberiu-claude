#!/usr/bin/env python3
# START YOUR COMPANY TONIGHT - Vertex GTM dashboards in phone frame, TikTok+IG (deck_poll)
...
T2.CONTENT=[
  ("LIVE", [[wo("A whole company,")],[co("running tonight.")]], f"{PH}/m1_01.png", 1.0),
  ("LEADS", [[wo("It finds your")],[co("first buyers.")]], f"{PH}/m1_02.png", 1.0),
  ("OUTREACH", [[wo("It writes")],[co("every message.")]], f"{PH}/m1_03.png", 1.0),
  ("UNITS", [[wo("Seven units,")],[co("one operator.")]], f"{PH}/m1_04.png", 1.0),
  ("PROJECTS", [[wo("Every workstream,")],[co("one place.")]], f"{PH}/m1_05.png", 1.0),
  ("MEMORY", [[wo("It remembers")],[co("everything.")]], f"{PH}/m1_06.png", 1.0),
  ("STACK", [[wo("Your whole stack,")],[co("connected.")]], f"{PH}/m1_07.png", 1.0),
