...
def sign1():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 40px">
      ...
      <div style="font-family:DM Mono;font-size:14px;color:{MUT};margin-top:22px">if you type the same reply again and again → that is a skill, not a job</div>
      {foot([("40x","PER WEEK"),("1","ANSWER"),("skill","NOT A JOB")])}</div>'''
...
def sign2():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 42px">
      ...
      <div style="font-family:DM Mono;font-size:14px;color:{MUT};text-align:center;margin-top:14px">a human moving rows between tabs is an integration waiting to happen</div>
      {foot([("by hand","MOVED"),("2","TABS"),("0","INTEGRATION")])}</div>'''
...
def sign3():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 42px">
      ...
      <div style="font-family:DM Mono;font-size:14px;color:{MUT};text-align:center">if everything waits on your two hands, your hands are the cap</div>
      {foot([("5","QUEUED"),("2","YOUR HANDS"),("cap","= YOU")])}</div>'''
...
def sign4():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 42px">
      ...
      <div style="font-family:DM Mono;font-size:14px;color:{MUT};text-align:center;margin-top:18px">every hour unanswered halves the odds; the inbox is where deals go to freeze</div>
      {foot([("50%","ODDS / HOUR"),("cold","= DEAD"),("0","AUTO-REPLY")])}</div>'''
...
def sign5():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 40px">
      ...
      <div style="display:flex;align-items:center;gap:12px">
        ...
        <span style="font-family:DM Sans;font-size:17px;color:#e9e3d7">3 days gone to reconciliation, every single month</span></div>
      {foot([("3","DAYS / MONTH"),("recon","MONTH-END"),("gone","EVERY TIME")])}</div>'''
...
def test():
    ...
    return f'''<div style="width:900px;{CARD};padding:34px 40px 42px"><div style="display:flex;align-items:center;gap:40px">
      ...
      {foot([("3 / 5","SIGNS"),("you","= THE SYSTEM"),("now","AUTOMATE")])}</div>'''
...
def fix():
    return f'''<div style="width:900px;{CARD};padding:34px 40px 44px">
      ...
      {foot([("1","SENTENCE"),("1","LEAK SEALED"),("worst","FIRST")])}</div>'''
...
def gate():
    return f'''<div style="width:900px;{CARD};padding:34px 40px 42px">
      ...
      <div style="font-family:DM Mono;font-size:14px;color:{MUT};text-align:center;margin-top:18px">it does the work at machine speed and stops at your one tap</div>
      {foot([("240","DRAFTED"),("1","YOUR TAP"),("0","AUTO-SENT")])}</div>'''
